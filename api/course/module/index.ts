...
export async function createCourseModule(
  ...
  return apiRequest<ApiResponse<Course>>(`${COURSE_MODULE_API_PREFIX}/create`, "POST", { body });
}

export async function updateCourseModule(id: number | string, body: Partial<CourseFormData>) {
