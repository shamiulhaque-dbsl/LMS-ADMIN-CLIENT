...
import LiveClassHistoryTable from "./LiveClassHistoryTable";
...
export default function ManageLiveClassesHistory() {
  return (
    <>
      {/* <CoursesFilters /> */}
        ...
        <Card.Content className="p-4 sm:p-6">
          <ErrorBoundary fallback={<ErrorMessage />}>
            <Suspense fallback={<TableSkeleton columns={11} rowCount={5} />}>
              <LiveClassHistoryTable fetchLiveClasses={fetchLiveClasses} />
            </Suspense>
          </ErrorBoundary>
        </Card.Content>
      </Card>
