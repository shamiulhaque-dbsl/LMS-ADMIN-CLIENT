  ...
  return (
    <div className="py-4">
      <div className="flex items-center justify-center gap-4">
        ...
        <Button size="sm" className="border border-gray-300 rounded-full">
          <Plus size={16} />
          <span className="ml-2">Add Lesson</span>
        </Button>
        <Button size="sm" className="border border-gray-300 rounded-full">
          <Plus size={16} />
          <span className="ml-2">Sort Section</span>
        </Button>
      </div>

      {/* Section List with Lessons List */}
      <div className="mt-12">
        <div className="bg-blue-200/40 p-4 rounded-md">
          {/* Section Title with Actions */}
          <div className="flex items-center justify-between flex-wrap gap-2">
            <div className="flex items-center gap-2 text-sm">
              <span>Section 1:</span>
              <span className="font-semibold">Getting Started With This Course</span>
            </div>
...
export default function ManageCourseEdit() {
